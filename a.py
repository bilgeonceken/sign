...
# inverted_image.save('inv_floor.jpg')


# wr = cv2.imread("inv_floor.jpg", cv2.IMREAD_UNCHANGED)
...
wr = cv2.imread("sample.jpeg", cv2.IMREAD_UNCHANGED)
